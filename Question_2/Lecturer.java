public class Lecturer implements User{
    ...
    private CourseFactory courseFactory = CourseFactory.getInstance();
    ...
    //private constructor in order to prevent free instantiation of the class
    private Lecturer(String name) {
        this.name = name;
    }

    public static Lecturer createInstance(String name){
